    ...
    <section data-scroll ref={mainRef} id="pages" >
      ...
      <section className="page" id="final-image-section">
        <div data-scroll data-scroll-speed={-2} id="final-image-wrapper">
          <img alt="NA" src="https://images.unsplash.com/photo-1484626753559-5fa3ea273ae8?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
        </div>
      </section>
      <Footer />
    </section>
